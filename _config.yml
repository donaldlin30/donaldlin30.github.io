...
title: Donald (Xin) Lin # the website title (if blank, full name will be used instead)
first_name: Donald
middle_name: 
last_name: Lin
email: dxinlin@umich.edu
description: > # the ">" symbol means to ignore newlines until "footer_text:"
  PhD student at the Univeristy of Michigan, interested in AI for healthcare.
footer_text: >
keywords: machine-learning, ML, artificial-intelligence, AI, healthcare, causal-inference, umich, cs # add your own keywords or leave empty
lang: en # the language of your site (for example: en, fr, cn, ru, etc.)
icon: UM.jpg # the emoji used as the favicon (alternatively, provide image name in /assets/img/)

url: https://donaldxinlin.github.io # the base hostname & protocol for your site
...
github_username: donaldlin30 # your GitHub user name
gitlab_username: # your GitLab user name
x_username: DonaldLin30 # your X handle
mastodon_username: # your mastodon instance+username in the format instance.tld/@username
linkedin_username: donald-lin-887755195 # your LinkedIn user name
